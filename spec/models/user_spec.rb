...
describe "A user" do
  ...
  before(:each) do
    create_activity user: user, distance: 100, ascent: 20, achievements: 1,
      date: 2.days.ago
    create_activity user: user, distance: 5, ascent: 10, achievements: 98,
      date: 1.day.ago
  end
  ...
  context "with a challenge that started 5 days ago and a second user" do
    ...
    before(:each) do
      ...
      @activity3 = create_activity user: user2, distance: 50,
